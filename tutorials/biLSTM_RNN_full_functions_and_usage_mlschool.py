...
# data_csv = "_example_results_all35_bioset_1_exps_23_08_20.csv"
...
data_csv = "_example_results_old18_bioset_1_exps_23_08_20.csv"

num_experements = 1

cell_line = 'is_s2' # Select cell line as one of: 'is_s2', 'is_kc', 'is_bg',  or 'all'
...
eval_models_df_1_10x_old18, eval_models_df_drop_10x_old18, eval_models_df_together_10x_old18,             mean_together_10x_old18, std_together_10x_old18, feature_score_1, feature_score_drop,             data_scaled_clean, target_clean, = main_analysis(data_path,  
                                                       cell_line, 
                                                       bioset, 
                                                       num_experements,
                                                       sequenc_len_list = [6], 
...
eval_models_df_1_10x_5f, eval_models_df_drop_10x_5f, eval_models_df_together_10x_5f,             mean_together_10x_5f, std_together_10x_5f, feature_score_1, feature_score_drop,             data_scaled_clean, target_clean, = main_analysis(data_path,  
                                                       cell_line, 
                                                       bioset, 
                                                       num_experements,
                                                       sequenc_len_list = [6], 
...
# data_csv = "_example_results_old18_bioset_10_exps_23_04_20.csv"
